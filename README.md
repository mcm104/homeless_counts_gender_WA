...
This dataset is a collection of CoC Homeless Assistance Programs gender demographic data in Washington state from 2015 to 2019. It has been curated for the benefit of policymakers at the municipal, county, and state level in Washington state so they can make informed decisions about how policies in recent years have impacted different gender demographics experiencing homelessness, and make decisions going forward that will assist those in dire need of housing solutions. This dataset contains information on cisgender males, cisgender females, transgender persons, and gender non-conforming persons, the numbers of which are broken down further by housing status at time of the count: in an emergency shelter, in transitional housing, or unsheltered.
